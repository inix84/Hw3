public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(long2 + "или точнее вот это число 987678965549 - это переменная типа long но почему то выдал ошибку " +
                "на количество знаков, поэтому тип double");
        ...
        System.out.println(int5+" - это переменная типа int");
        System.out.println();
